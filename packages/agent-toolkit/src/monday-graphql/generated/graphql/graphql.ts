...
export type SetItemDescriptionContentMutationVariables = Exact<{
  itemId: Scalars['ID']['input'];
  markdown: Scalars['String']['input'];
}>;


export type SetItemDescriptionContentMutation = { __typename?: 'Mutation', set_item_description_content?: { __typename?: 'DocBlocksFromMarkdownResult', success: boolean, block_ids?: Array<string> | null, error?: string | null } | null };
