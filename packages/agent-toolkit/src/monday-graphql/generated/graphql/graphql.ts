...
export type UseTemplateStatusType = {
  ...
  /** Map of source board ID (string) to created board ID (string). */
  board_ids_map?: Maybe<Scalars['JSON']['output']>;
...
export type UseTemplateStatusQuery = { __typename?: 'Query', template_installation_status?: { __typename?: 'UseTemplateStatusType', process_id: string, status: UseTemplateStatus, board_ids: Array<string>, board_ids_map?: any | null } | null };
