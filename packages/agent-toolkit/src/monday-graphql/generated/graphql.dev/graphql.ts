...
export type WorkflowFieldsFragment = { __typename?: 'Workflow', id: string, user_id: number, is_active: boolean, automation_id: string, title: string, description: string, importance?: number | null, notice_message?: string | null, template_reference_id?: string | null, created_at: any, updated_at: any, workflow_variables: any, workflow_host_data: { __typename?: 'WorkflowHostData', type: HostType, id?: string | null }, workflow_blocks: Array<{ __typename?: 'WorkflowBlock', workflowNodeId: number, blockReferenceId: number, title: string, kind: WorkflowBlockKind }> };
