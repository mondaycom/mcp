...
export const createFolderToolSchema = {
  workspaceId: z.number().describe('The ID of the workspace where the folder will be created'),
  ...
  parentFolderId: z.number().optional().describe('The ID of the parent folder'),
};
