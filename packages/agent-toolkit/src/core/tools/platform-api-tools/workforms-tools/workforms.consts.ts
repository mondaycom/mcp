export const GraphQLDescriptions = {
  ...
  formSettings: {
    ...
    properties: {
      ...
      allowViewSubmission: '',
      preSubmissionView: '',
      preSubmissionEnabled: '',
      preSubmissionTitle: '',
      preSubmissionDescription: '',
      startButton: '',
      startButtonText: '',
      afterSubmissionView: '',
      postSubmissionTitle: '',
      ...
      redirectAfterSubmissionEnabled: '',
      redirectUrl: '',
      monday: '',
      itemGroupId: '',
  ...
  question: {
    actions: {
      type: 'Operation: create, update, or delete. questionId required for update/delete. question required for create/update. Update is patch.',
      question: 'Question to create/update. title required when creating.',
    },
    properties: {
      title: 'Question text. Required when creating.',
      type: 'Question type. Determines available settings.',
      visible: '',
      required: '',
