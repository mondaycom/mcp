...
export const updateFormToolSchema = {
  ...
  [`tag${STRINGIFIED_SUFFIX}`]: z.string().optional().describe('**ONLY FOR MICROSOFT COPILOT**: The tag data. Send this as a stringified JSON of "tag" field. Read "tag" field description for details how to use it.'),
  form: formSchema.describe(GraphQLDescriptions.form.inputs.form.describe).optional(),
  [`form${STRINGIFIED_SUFFIX}`]: z.string().optional().describe('**ONLY FOR MICROSOFT COPILOT**: The form data. Send this as a stringified JSON of "form" field. Read "form" field description for details how to use it.'),
};
