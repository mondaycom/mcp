...
import { BoardRelationValue, FormulaValue, GetBoardItemsPageQuery, GetBoardItemsPageQueryVariables, ItemsOrderByDirection, ItemsQueryOperator, ItemsQueryRuleOperator } from '../../../../monday-graphql/generated/graphql/graphql';
...
export class GetBoardItemsPageTool extends BaseMondayApiTool<GetBoardItemsPageToolInput> {
  ...
  private async getItemIdsFromSmartSearchAsync(input: ToolInputType<GetBoardItemsPageToolInput>): Promise<number[]> {
    ...
    const smartSearchRes = await this.devMondayApiClient.request<SearchItemsDevQuery>(searchItemsDev, smartSearchVariables);
