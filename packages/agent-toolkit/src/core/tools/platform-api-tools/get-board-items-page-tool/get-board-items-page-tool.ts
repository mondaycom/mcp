...
export const getBoardItemsPageToolSchema = {
  ...
  limit: z.number().min(1).max(100).optional().describe('The number of items to get'),
  cursor: z.string().optional().describe('The cursor to get the next page of items'),
  includeColumns: z.boolean().optional().describe('Whether to include column values in the response'),
};
