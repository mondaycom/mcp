  ...
  describe('Behaviour Tests', () => {
    ...
    describe('Create New Item Path', () => {
      it('Successfully creates a new item', async () => {
        ...
        expect(result.content).toEqual({
          message: 'Item 123456789 successfully created',
          item_id: '123456789',
          item_name: 'New Item',
          item_url: undefined,
          board_id: 456,
      ...
      it('Successfully creates a new item with boardId in input', async () => {
        ...
        const tool = new CreateItemTool(mocks.mockApiClient);
    ...
    describe('Duplicate and Update Item Path', () => {
      it('Successfully duplicates and updates an item', async () => {
        ...
        expect(result.content).toEqual({
          message: 'Item 987654321 duplicated from 123',
          item_id: '987654321',
          item_name: 'Duplicated Item',
          item_url: undefined,
          board_id: 456,
        });
        ...
        expect(MockedChangeItemColumnValuesTool).toHaveBeenCalledWith(mocks.mockApiClient, {
          boardId: 456,
        });
    ...
    describe('Create Subitem Path', () => {
      ...
      it('Successfully creates a subitem', async () => {
        ...
        expect(result.content).toEqual({
          message: 'Subitem 111222333 created under 123',
          item_id: '111222333',
