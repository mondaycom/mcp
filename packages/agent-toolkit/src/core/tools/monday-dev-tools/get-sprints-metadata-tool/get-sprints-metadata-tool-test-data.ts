        ...
        items: [
          // Planned Sprint (not started)
          {
            ...
            column_values: [
              ...
              { __typename: 'DateValue' as const, id: 'sprint_start_date', type: NonDeprecatedColumnType.Date, date: null },
          ...
          // Completed Sprint (without summary document)
          {
            ...
            column_values: [
              ...
              { __typename: 'DateValue' as const, id: 'sprint_start_date', type: NonDeprecatedColumnType.Date, date: '2025-08-03' },
              { __typename: 'DateValue' as const, id: 'sprint_end_date', type: NonDeprecatedColumnType.Date, date: '2025-08-18' },
              {
                __typename: 'TimelineValue' as const,
                id: 'sprint_timeline',
                type: NonDeprecatedColumnType.Timeline,
