...
export class GetAllAppsTool extends BaseMondayAppsTool<undefined, AppApiDataResponse> {
  ...
  getDescription(): string {
    return 'Retrieve all the development apps that the user has collaboration permissions for. Returns a list of apps with their IDs, names, and multi-region configuration. Use this to discover available apps before performing other operations.';
  }
