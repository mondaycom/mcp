...
export const getAppVersionSchema = z.object({
  versionId: z.number().describe('The unique identifier of the specific app version to retrieve. Version IDs are returned from get_app_versions and represent individual snapshots of your app configuration'),
});
