...
export const getDeploymentStatusSchema = z.object({
  appVersionId: z.number().describe('The unique identifier of the app version to check deployment status for. Use this after running mapps code:push to monitor the deployment progress and verify it completed successfully'),
});
